...
namespace WebAppNetCore1.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var list = _context.Alumnos.ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("IdAlumno,Nombres,Apellidos,Edad")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdAlumno,Nombres,Apellidos,Edad")] Alumno alumno)
        {
